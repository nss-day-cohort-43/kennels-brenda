...
export const AnimalForm = () => {
    ...
    const handleControlledInputChange = (event) => {
        ...
        //newAnimal is an object with properties. 
        //set the property to the new value
        //conditional for the checkbox
        if(event.target.name === "status"){
            newAnimal[event.target.name] = newAnimal.status ? false : true
        }else {
    ...
    return (
        <form className="animalForm">
			...
			{animalId ? `Edit ${animal.name} information` : "New Animal"}
			</h2>
            <fieldset>
                <div className="form-group">
                    ...
                    onChange={(event) => handleControlledInputChange(event)} 
                    value={animal.name}/>
                </div>
            </fieldset>
            <fieldset>
            ...
            <fieldset>
                Food: <input type="checkbox" name="status" value={animal.status} checked={animal.status} 
